...
SmoothShadedTriangle::SmoothShadedTriangle(Material* material, Vector3 v0, Vector3 v1, Vector3 v2, Vector3 n0, Vector3 n1, Vector3 n2): Object(material) {
    this->v0 = v0;
    this->v1 = v1;
    this->v2 = v2;
    this->n0 = n0;
...
bool SmoothShadedTriangle::rayIntersect(Ray r, float min, float max, float& time) {
