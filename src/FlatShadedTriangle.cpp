...
FlatShadedTriangle::FlatShadedTriangle(Material* material, Vector3 v0, Vector3 v1, Vector3 v2): Object(material) {
    this->v0 = v0;
    this->v1 = v1;
    this->v2 = v2;
...
bool FlatShadedTriangle::rayIntersect(Ray r, float min, float max, float& time) {
...
Vector3 FlatShadedTriangle::calculateNormal(Vector3 point) {
    Vector3 e1 = this->v1 - this->v0;
    Vector3 e2 = this->v2 - this->v0;
    return cross(e1, e2);
}
